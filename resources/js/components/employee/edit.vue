<template>
    <div>
        <div class="row col-xl-3 col-lg-3 col-md-3">
            <router-link to="/employee" class="btn btn-primary btn-sm">Add Employee</router-link>
        </div>
                        ...
                        <form class="user" @submit.prevent="employeeUpdate" enctype="multipart/form-data">
                            <div class="form-group">
                                <div class="form-row">
                                    ...
                                    <div class="col-md-6">
                                    <input type="email" class="form-control" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter Your Email" v-model="form.email">
                            ...
                            <div class="form-group">
                                <div class="form-row">
                                    ...
                                    <div class="col-md-6">
                                    <input type="text" class="form-control" id="exampleInputEmail" placeholder="Enter Your Salary" v-model="form.salary">
                            ...
                            <div class="form-group">
                                <div class="form-row">
                                    ...
                                    <div class="col-md-6">
                                    <input type="text" class="form-control" id="exampleInputEmail" placeholder="Enter Your NID" v-model="form.nid">
