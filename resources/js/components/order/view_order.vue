                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-6 mb-4">
                            ...
                            <div class="card">
                              <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                <h6 class="m-0 font-weight-bold text-primary">Simple Table</h6>
                              </div>
                              <div class="table-responsive">
                                <ul class="list-group">
                                <li class="list-group-item"><b>Sub Total: </b>{{orders.name}}</li>
                                <li class="list-group-item"><b>VAT: </b>{{orders.phone}}</li>
                                <li class="list-group-item"><b>Total: </b>{{orders.address}}</li>
                                <li class="list-group-item"><b>Pay: </b>{{orders.order_date}}</li>
                                <li class="list-group-item"><b>Due: </b>{{orders.payby}}</li>
                              </ul>
                              </div>
                              <div class="card-footer"></div>
                            </div>
